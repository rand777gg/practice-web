...
function qualityProfileForGate(profile) {
  // Browser-safe: the upstream `process.env.ARCHIFY_QUALITY_PROFILE || profile`
  // override is dropped; the authored quality profile is authoritative.
  return profile;
}
