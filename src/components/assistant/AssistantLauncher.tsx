    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <button
          ...
          aria-label="问问小Q"
          className="ai-ring fixed bottom-24 right-4 z-30 flex items-center gap-2 rounded-full border bg-background/95 p-1.5 pr-3 shadow-xl shadow-primary/10 backdrop-blur transition-transform hover:scale-[1.03] xl:bottom-6 xl:right-6"
        >
