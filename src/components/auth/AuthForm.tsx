      ...
      <form onSubmit={handleSubmit}>
        <FieldGroup>
          ...
          <Field className="flex justify-center">
            <Button variant="ghost" size="icon" type="button" className="rounded-full size-10 bg-transparent hover:bg-white/10" onClick={() => supabase.auth.signInWithOAuth({ provider: 'github', options: { redirectTo: window.location.origin } })}>
