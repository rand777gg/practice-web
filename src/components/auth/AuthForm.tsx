  ...
  return (
    <div className={cn("flex flex-col gap-6 w-full transition-all duration-500", imageHidden ? "max-w-md" : "max-w-4xl", className)} {...props}>
      <div className="relative md:min-h-[560px]">
        <Card className={cn("overflow-hidden p-0 md:min-h-[560px] flex flex-col transition-opacity duration-500 absolute inset-0 bg-white/40 backdrop-blur-md border-0 shadow-xl shadow-black/5", imageLoaded ? "opacity-0 pointer-events-none" : "opacity-100 z-10")}>
        ...
        <Card className={cn("overflow-hidden p-0 md:min-h-[560px] flex flex-col transition-opacity duration-500 bg-white/40 backdrop-blur-md border-0 shadow-xl shadow-black/5", imageLoaded ? "opacity-100" : "opacity-0")}>
        <CardContent className={cn("grid p-0 flex-1", !imageHidden && "md:grid-cols-2")}>
